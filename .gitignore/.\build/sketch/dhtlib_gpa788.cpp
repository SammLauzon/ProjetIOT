#line 1 "/Users/samuellauzon/Sam/Ecole/AUT2021/GPA788/LAB1/ProjetIOT/dhtlib_gpa788.cpp"
//
//    FILE: dht.cpp
//  AUTHOR: Rob Tillaart
// VERSION: 0.1.14
...
DHTLIB_ErrorCode dhtlib_gpa788::read11(uint8_t pin)
{
    ...
    {
        humidity    = double(DHTLIB_ErrorCode::DHTLIB_INVALID_VALUE); // invalid value, or is NaN prefered?
        temperature = double(DHTLIB_ErrorCode::DHTLIB_INVALID_VALUE); // invalid value
        return rv;
    }
