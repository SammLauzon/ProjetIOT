...
void loop()
{
  ...
  if (cmd == CMD::Go) {
    ...
    Serial.print(F("Échantillon #")); Serial.print(cr.champs.nb_echantillons); 
    Serial.print(F("  Humidité relative : ")); Serial.print(cr.champs.humidity);
    Serial.print(F("  Température : ")); Serial.print(cr.champs.temperature); Serial.print(F("  "));
    Serial.print(cr.champs.Ts); Serial.print(F(" sec\n"));
